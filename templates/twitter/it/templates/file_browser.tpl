...
<tr>
    ...
    <td><div class="btn-group"><a class="btn" href="index.php?action=file_manipulator&amp;action_file=overview&amp;file={$file_new_name[id]}"><i class="icon-wrench"></i> Modifica</a>    <a class="btn dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>    <ul class="dropdown-menu">    <li><a href="index.php?action=file_manipulator&amp;action_file=visibility_change&amp;file={$file_new_name[id]}"><i class="icon-pencil"></i> Cambia visibilità</a></li>    <li><a href="#" onclick="return alert('http://{$smarty.const.SCRIPT_URL}{$smarty.const.DIR_INSTALL}/index.php?action=download&amp;file={$file_new_name[id]}')"><i class="icon-share"></i> Condividi</a></li>    <li><a href="index.php?action=file_manipulator&amp;action_file=delete&amp;file={$file_new_name[id]}" onclick="return confirm('Attenzione! Questa operazione sarà irreversibile. Il file {$file_name[id]} verrà eliminato dal sistema. Continuare? ')"><i class="icon-trash"></i> Cancella</a></li>    <!--<li class="divider"></li>    <li class="divider"></li>    <li><a href="#"><i class="i"></i> Make admin</a></li>-->    </ul>    </div></td>
